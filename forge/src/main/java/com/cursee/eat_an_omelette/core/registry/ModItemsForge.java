...
public class ModItemsForge {
    ...
    public static final RegistryObject<Item> GOLDEN_OMELETTE = RegistryForge.registerItem("golden_omelette", () -> new Item(
            new Item.Properties().food(new FoodProperties.Builder()
                    ...
                    .alwaysEdible().build())));
    public static final RegistryObject<Item> ENCHANTED_GOLDEN_OMELETTE = RegistryForge.registerItem("enchanted_golden_omelette", () -> new Item(new Item.Properties().food(
                    new FoodProperties.Builder()
                            .nutrition(8)
                            .saturationModifier(2.4f)
